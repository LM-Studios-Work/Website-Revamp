    ...
    <div ref={containerRef} className="min-h-screen relative text-white bg-black font-sans selection:bg-[#d4f534] selection:text-black overflow-x-hidden">\n      
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 py-16 sm:py-20 md:py-24 lg:py-32">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3 sm:px-4 py-1 sm:py-1.5 border border-white/10 bg-white/5 rounded-full text-gray-400 text-xs font-bold tracking-widest uppercase mb-4 sm:mb-6">
              <Sparkles className="w-3 h-3 text-[#d4f534]" />
              Meet the Makers
            </motion.div>

            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-extrabold mb-4 sm:mb-6 tracking-tighter leading-none">
              The Team
            </motion.h1>
            ...
            <motion.p variants={fadeInUp} className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-gray-400 mt-6 sm:mt-8 md:mt-10 font-light px-4">
              We are a{" "}
