    ...
    <PageLayout containerRef={containerRef} currentPage="johannesburg-web-design" onPageChange={onPageChange}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight text-balance">
                The Best Web Design in{" "}
                <span className="text-[#d4f534]">Johannesburg</span>
              </motion.h1>
              <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-white/60 leading-relaxed max-w-xl">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-balance">
              Why We Are the Best Web Designers in <span className="text-[#d4f534]">Joburg</span>
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-white/50 max-w-2xl mx-auto text-lg">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="relative bg-gradient-to-br from-[#d4f534]/10 to-transparent border border-[#d4f534]/20 rounded-3xl p-8 sm:p-10">
            ...
            <motion.div variants={fadeInUp} className="relative bg-gradient-to-br from-[#5dd9c1]/10 to-transparent border border-[#5dd9c1]/20 rounded-3xl p-8 sm:p-10">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              <motion.div key={idx} variants={fadeInUp} className="mb-8 last:mb-0">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-white/50 text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            variants={isMobile ? staggerContainerMobile : staggerContainer}
          >
            <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl font-bold mb-10 text-center text-balance">
            ...
            {[
              ...
              <motion.div key={idx} variants={fadeInUp} className="border-b border-white/[0.06] last:border-0">
                <button
