    ...
    >
      ...
      <div className="relative z-10 flex flex-col">
        {/* =========================================
            HERO SECTION
           ========================================= */}
        {/* Changed min-h to utilize dvh for mobile browsers and reduced top padding on mobile */}
        <header className="relative w-full min-h-[90dvh] lg:min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden py-20 lg:py-0">
          <motion.div style={{ y: heroY, opacity: heroOpacity }} className="w-full max-w-[1000px] mx-auto lg:mx-0">
            {/* Brand Title */}
            <motion.div
              initial="hidden"
              animate="visible"
            ...
            >
              <div className="flex flex-col md:flex-row md:items-baseline leading-none select-none">
                {/* Responsive font sizes to prevent wrapping/overflow on small screens */}
                <motion.span
                  variants={fadeInUp}
                ...
                <div className="flex flex-col relative z-20">
                  ...
                  {/* Adjusted height and margin for mobile */}
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: "100%" }}
            ...
            >
              <button 
                ...
                className="group relative bg-[#d4f534] text-black font-bold py-4 px-8 sm:py-5 sm:px-10 rounded-full flex items-center gap-3 overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(212,245,52,0.3)] touch-manipulation w-fit"
              >
        ...
        {/* =========================================
            SERVICES SECTION
           ========================================= */}
        {/* Adjusted vertical padding to be smaller on mobile */}
        ...
        <section className="px-4 sm:px-6 md:px-8 py-16 md:py-24 lg:py-32 overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              {/* Annotation - Hidden on mobile to prevent overflow/overlap */}
              <motion.div 
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
                className="hidden lg:block absolute -top-16 -left-12 z-20 pointer-events-none"
              >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="group p-5 md:p-6 rounded-2xl border border-white/5 bg-black/40 hover:bg-[#d4f534]/5 hover:border-[#d4f534]/30 transition-all duration-300"
                    >
                      <div className="flex items-start gap-4">
                        <div className="p-3 rounded-full bg-white/5 text-[#d4f534] group-hover:scale-110 transition-transform shrink-0">
                          <feature.icon className="w-5 h-5 md:w-6 md:h-6" />
                        </div>
                        <div>
                          <h3 className="text-lg md:text-xl font-bold text-white mb-2 group-hover:text-[#d4f534] transition-colors">
                            {feature.title}
                          </h3>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-black text-white font-bold py-4 px-8 md:py-5 md:px-10 rounded-full flex items-center gap-3 hover:bg-gray-900 transition-colors text-base md:text-lg mx-auto shadow-2xl"
                >
                  Start your project
...
function ServiceCard({ title, subtitle, description, icon, image, items, accentColor }: ServiceCardProps) {
  return (
    <motion.div
      variants={fadeInUp}
      className="group relative bg-white/5 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2rem] overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-500 flex flex-col h-full"
    >
