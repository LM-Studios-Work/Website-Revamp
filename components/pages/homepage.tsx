    ...
    <section className="px-4 sm:px-6 md:px-8 py-16 md:py-24 lg:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-8 leading-[1.1]">
            Built for <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">your industry.</span>
          </h2>

          <div className="space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground font-light border-l border-white/10 pl-6">
            <p>
