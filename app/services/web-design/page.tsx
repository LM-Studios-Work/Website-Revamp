...
export default function WebDesignPage() {
  ...
  return (
    <div className="min-h-screen relative text-white bg-black font-sans selection:bg-[#d4f534] selection:text-black">
      {/* Global Background */}
      <div
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1">
            <div className="mb-6">
              ...
              <span className="px-4 py-1 border border-[#d4f534] text-[#d4f534] rounded-full text-sm inline-block tracking-wider uppercase">
          ...
          <div className="flex-1 w-full">
            <div className="rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_40px_rgba(212,245,52,0.1)] relative">
              <div className="absolute inset-0 bg-[#d4f534]/10 mix-blend-overlay"></div>
              <img
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <div className="flex gap-6 overflow-x-auto pb-8 scrollbar-hide snap-x">
              {/* Card 1 - Sitemap */}
              <div className="snap-center flex-none w-[85vw] md:w-[350px] bg-[#d4f534] text-black rounded-3xl p-8 relative group">
              ...
              <div className="snap-center flex-none w-[85vw] md:w-[350px] bg-[#ff6b6b] text-black rounded-3xl p-8 relative group">
                ...
                <p className="text-base leading-relaxed font-medium opacity-80">
                  We bring the design to life with clean, SEO-friendly code using modern frameworks.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-8 hidden md:flex">
              <button className="w-12 h-12 rounded-full border border-[#d4f534] text-[#d4f534] flex items-center justify-center hover:bg-[#d4f534] hover:text-black transition-all">
                <ChevronLeft className="w-6 h-6" />
              </button>
              <button className="w-12 h-12 rounded-full bg-[#d4f534] text-black flex items-center justify-center hover:bg-[#c7e81f] transition-all shadow-[0_0_15px_#d4f534]">
